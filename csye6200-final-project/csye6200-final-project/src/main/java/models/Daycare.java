...
public class Daycare {
    ...
    public void sortStudentsByName() {
        Collections.sort(listStudent, Comparator.comparing(Student::getInstructorFirstName));
    }

    // Method to sort students by age
    public void sortStudentsByAge() {
        Collections.sort(listStudent, Comparator.comparingInt(Student::getInstructorAge));
    }
